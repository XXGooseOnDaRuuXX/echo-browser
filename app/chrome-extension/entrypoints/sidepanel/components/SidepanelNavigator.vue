<template>
  ...
  >
    ...
    <button
      ...
      title="Switch view (drag to move, double-click to reset)"
    >
      <svg
      ...
      <div v-if="isOpen" class="navigator-overlay" @click="closeMenu">
        <div class="navigator-menu" :style="menuStyle" @click.stop>
          <div class="navigator-header">
            <span class="navigator-title">Switch View</span>
          ...
          <div class="navigator-items">
            ...
            >
              ...
              <div class="navigator-item-content">
                ...
                <span class="navigator-item-desc">Chat & tasks</span>
              </div>
            ...
            >
              ...
              <div class="navigator-item-content">
                ...
                <span class="navigator-item-desc">Record & replay automation</span>
              </div>
